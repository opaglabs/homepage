      ...
      >
        <div class="grid grid-cols-1 justify-items-center">
          <svg
            ...
            class="bg-white cover h-16 w-auto rounded-xl hidden lg:block"
            id="Camada_1"
            data-name="Camada 1"
      ...
      <div class="max-w-7xl mx-auto lg:mt-14 p-4 lg:p-0">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div
            v-for="i in 6"
            :key="i"
            class="bg-gray-200 w-full h-80 flex justify-center items-center"
          >
            <div class="text-xl">
              {{ "Passo " + i }}
            </div>
      ...
      >
        <div class="grid grid-cols-1 justify-items-center">
          <svg :class="{
            ...
            'text-purple-600': color === 'purple',
            'text-pink-600': color === 'pink',
          }" class="bg-white cover h-16 w-auto rounded-xl hidden lg:block" id="Camada_1" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
            <rect width="512" height="512" style="fill: none"/>
            <g>
          ...
          <h1 class="text-5xl text-white p-8">Vamos trabalhar juntos?</h1>
        </div>
      </div>

      <div class="flex justify-center">
        <div class="absolute bottom-32 lg:w-1/3 w-full rounded border-gray-400 p-4 grid grid-cols-1 gap-4">
          <x-input
          ...
          <button
            class="w-full text-white rounded-xl p-4 text-xl font-bold"
            v-ripple
            :class="{
              'bg-red-600': color === 'red',
              'bg-yellow-600': color === 'yellow',
